...
function CartItemCard({ item, index, onRemoveFromCart }) {
  ...
  return (
    <article className="flex items-center justify-between gap-3 rounded-xl border border-[#e8e9f0] p-3">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h4 className="m-0 font-heading text-lg font-bold text-[#1d1f3a]">{item.name}</h4>
